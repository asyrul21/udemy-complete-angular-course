// since the app now implements ngrx redux state management,
// this file can now be deleted.
// if you delete, need to remove all imports and references
// to this service.
// For references, I will leave this file here
